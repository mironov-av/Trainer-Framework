...
{
    class ClearToggle : Control
    {
        private float diameter;
        private ToggleSwitchesRectangle rect;
        ...
        public ClearToggle()
        {
            ...
            this.artis = 4f;
            this.diameter = 30f;
            this.rect = new ToggleSwitchesRectangle(2f * this.diameter, this.diameter + 2f, this.diameter / 2f, 1f, 1f);
            this.isON = false;
            ...
            this.OffCol = Color.DarkSlateGray;
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            if (base.Enabled)
            {
                ...
                if (this.textEnabled)
                {
                    ...
                    using (SolidBrush brush2 = new SolidBrush("#282c37".FromHex()))
                    {
                        e.Graphics.FillEllipse((Brush)brush2, this.circle);
                    }
                    using (pen = new Pen(Color.DarkSlateGray, 1.2f))
                    {
                ...
                {
                    using (SolidBrush brush3 = new SolidBrush("#393f4f".FromHex()))
                    {
                        using (SolidBrush brush4 = new SolidBrush("#282c37".FromHex()))
                        {
                            e.Graphics.FillPath((Brush)brush3, this.rect.Path);
                            e.Graphics.FillEllipse((Brush)brush4, this.circle);
                            e.Graphics.DrawEllipse(Pens.DarkSlateBlue, this.circle);
                        }
                    }
